...
class UserProfileTest(TestCase):
    ...
    def setUp(self):
        UserProfile.object.create(email="test@test.com", name="jalil")
    ...
    def test_create_user(self):
        ...
        self.assertEqual(user.get_full_name(), "jalil")
        self.assertEqual(user_admin.get_full_name(), "sara")
        self.assertEqual(user.get_email(), "test@test.com")
        self.assertEqual(user_admin.get_email(), "admin@admin.com")
...
class ProfileFeedItemsTest(TestCase):
    ...
    def setUp(self):
        ...
        admin = UserProfile.object.create(
    ...
    def test_create_user(self):
        user_feed_item = profileFeedItems.objects.get(
            user_id=UserProfile.object.get(name="jalil")
        )
        admin_feed_item = profileFeedItems.objects.get(
            user_id=UserProfile.object.get(name="sara")
        )

        self.assertEqual(user_feed_item.get_text_status(), "jalil Hi i am Jalil")
        self.assertEqual(admin_feed_item.get_text_status(), "sara Hi i am sara")
